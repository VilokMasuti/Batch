...
const Download = () => {
  return (
    <section className="relative mb-[1000px] max-sm:mt-[90px]  ">
             <Image
          src={star}
          alt="logo"
          width={50}
          objectFit="cover"
          className="object-center object-cover ml-[200px]"
        />
      {/* Image */}
      ...
      <div className="absolute max-sm:flex max-sm:flex-col max-sm:h-[760px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1100px] mt-[300px] h-[500px] bg-neutral-950 flex antialiased rounded-md">
        <div className='flex flex-col max-sm:ml-[340px] ml-12 mt-[170px]'>
          <h1 className='text-white uppercase font-mono font-extrabold max-sm:ml-[25px]   text-3xl'>ready to get started?</h1>
          <p className='text-white font-medium max-sm:text-center max-sm:w-[410px] pt-2 text-sm'>Risus habitant leo egestas mauris diam eget morbi tempus vulputate.</p>
          <div className="">
